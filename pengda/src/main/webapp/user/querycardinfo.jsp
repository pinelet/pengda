...
<body>
	    ...
	    <form id="querycardinfoform" method="post">
	        ...
	        <tr>
	            ...
	            <td align="left"><input id="cardcode" type="text"></input></td>
	           	<td align="right">持卡人姓名:</td>
	            <td align="left"><input id="cardname" type="text"></input></td>
	            <td align="right">卡中余额小于:</td>
	            <td align="left"><input id="balance" type="text"></input>元</td>     
	        </tr>
	        <tr>
	        	<td align="right">持卡人电话:</td>
    			<td align="left"><input id="phone" type="text"/></td>
    			<td align="right">办卡地址:</td>
    			<td align="left"><input id="address" type="text"/></td>    
